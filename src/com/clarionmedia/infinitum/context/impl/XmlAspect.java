...
public class XmlAspect extends XmlBean {
     ...
     *
     * @param advice {@code Advice} to set
     */
    ...
    public static class Advice {
         ...
         *
         * @param pointcut pointcut type to set
         */
         ...
         * corresponding to the pointcut type.
         *
         * @param value pointcut value to set
         */
         ...
         * or {@code around}.
         *
         * @param type {@code Advice} type to set
         */
         ...
         * precedence determines the order in which advice is executed.
         *
         * @param order {@code Advice} precedence to set
         */
