...
public abstract class AbstractCache<K, V> implements Map<K, V> {
     ...
     *
     * @param name the cache identifier used to derive a directory name if the
     ...
     * @param storageDevice where to store the cached files, either
     ...
     * @param value the {@link Object} to cache
     * @throws IOException
     */
     ...
     * @param key               the cache entry key
     * @param value             the value to cache
     * @param expirationTimeout the expiration timeout for the cache entry in seconds
     * @return the previously cached value with the given key or {@code null} if
     *         there is none
     */
