...
public interface ClassReflector {
     ...
     *
     * @param clazz the {@code Class} to get {@code Fields} for
     ...
     *
     * @param clazz the {@code Class} to get {@code Methods} for
     ...
     *
     * @param clazz the {@code Class} to get {@code Methods} for
     * @param name  the name of the {@code Methods} to retrieve
     * @return {@link List} of {@code Methods}
     */
     ...
     *
     * @param name       the name of the {@code Method}
     * @param clazz      the {@code Class} containing the desired {@code Method}
     * @param paramTypes the {@code Method} parameter types
     * @return {@code Method}
     */
     ...
     *
     * @param clazz      the {@code Class} to get {@code Methods} for
     * @param annotation the {@code Annotation} type to find {@code Methods} for
     * @return {@link List} of {@code Methods}
     */
     ...
     *
     * @param clazz the {@code Class} to get {@code Constructors} for
     ...
     * {@link Class}.
     *
     * @param clazz the {@code Class} to retrieve the {@code Field} from
     ...
     * {@link Object}.
     *
     * @param object the {@code Object} to retrieve the value for
     * @param field  the {@code Field} to retrieve the value for
     ...
     * constructor.
     *
     * @param clazz the {@code Class} to construct
     ...
     * arguments.
     *
     * @param receiver the {@link Object} to invoke the {@code Method} on
     ...
     *
     * @param object the {@code Object} to set the value for
     * @param field  the {@code Field} to set the value for
     * @param value  {@code Field} value to set
     */
     ...
     * {@code Object}.
     *
     * @param from the {@code Object} to copy from
     * @param to   the {@code Object} to copy to
     */
     ...
     *
     * @param clazz         the {@code Class} to retrieve an interface for
     * @param interfaceType the interface type the interface to retrieve must be
     *                      assignable from
     ...
     * @param annotation the {@code Annotation} to check for
