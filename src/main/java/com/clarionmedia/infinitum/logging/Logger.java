...
/**
 * <p> Prints log messages to Logcat. </p>
 *
 * @author Tyler Treat
...
public abstract class Logger {
     ...
     *
     * @param msg the message to log
     * @param tr  the {@link Throwable} to log
     */
    ...
    /**
     * Returns the tag assigned to this {@code Logger}. The tag is used to identify where a log message originated from.
     * Typically, it is the name of the {@link Activity} or class in which the {@code Logger} was called.
     *
    ...
    /**
     * Sets the tag assigned to this {@code Logger}. The tag is used to identify where a log message originated from.
     * Typically, it is the name of the {@link Activity} or class in which the {@code Logger} was called.
     *
